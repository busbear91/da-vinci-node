...
export const MODELS: Record<ModelId, { displayName: string; reactor: string; envKey: string }> = {
  ...
  phi4:    { displayName: 'HELIOS-3',  reactor: 'Helios-3 Fusion Test Bench', envKey: 'OLLAMA_URL_PHI4' },
  ...
  //mistral: { displayName: 'VULCAN-4',  reactor: 'Vulcan-4 Solar-Thermal Station',     envKey: 'OLLAMA_URL_MISTRAL' },
};
